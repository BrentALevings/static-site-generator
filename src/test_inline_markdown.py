...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_split_image(self):
        ...
        self.assertListEqual(
            [
                TextNode("This is text with an ", TextType.PLAIN_TEXT),
                TextNode("image", TextType.LINK_IMAGE, "https://i.imgur.com/zjjcJKZ.png"),
            ],
            new_nodes,
        )
    ...
    def test_split_image_single(self):
        ...
        self.assertListEqual(
            [
                TextNode("image", TextType.LINK_IMAGE, "https://www.example.COM/IMAGE.PNG"),
            ],
            new_nodes,
        )
    ...
    def test_split_images(self):
        ...
        self.assertListEqual(
            [
                ...
                TextNode(
                    "second image", TextType.LINK_IMAGE, "https://i.imgur.com/3elNhQu.png"
                ),
            ],
            new_nodes,
        )
