...
def generate_pages_recursive(dir_path: str, template_path: str, dest_dir_path: str):
    for obj in os.listdir(dir_path):
        # print(obj)
        if obj.endswith(".md"):
            generate_page(os.path.join(dir_path, obj), template_path, os.path.join(dest_dir_path, obj.replace(".md", ".html")))
        else:
            generate_pages_recursive(os.path.join(dir_path, obj), template_path, os.path.join(dest_dir_path, obj))
